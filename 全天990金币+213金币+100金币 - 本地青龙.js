...
let _0x134a17 = new Date(),
    ...
    _0x2e716e = 0,
    _0x5bc515 = "ksjsb",
    _0x180c0c = "https://ghproxy.com/https://raw.githubusercontent.com/seh23231/bb/main/ks.json",
    ksjsbjk = "https://ghproxy.com/https://raw.githubusercontent.com/seh23231/bb/main/ksjsb1.json",
    ...
    for (let Z of p) {
      ...
      if (Z["task"][_0x1e4967["luckydraw"]]["needRun"]) {
        for (let U = 0; U < Z["task"][_0x1e4967["luckydraw"]]["num"]; U++) {
          _0x20a9d7 < 23 ? (await Z["ksNeoAdParam"](_0x10d9f8["luckdrawVideo_161_213"]), await _0x3de8b8["wait"](200), await Z["ksNeoAdParam"](_0x10d9f8["luckdrawVideo_11_213"]), await _0x3de8b8["wait"](200)) : (await Z["ksNeoAdParam"](_0x10d9f8["luckdrawVideo_161_100"]), await _0x3de8b8["wait"](200), await Z["ksNeoAdParam"](_0x10d9f8["luckdrawVideo_11_100"]), await _0x3de8b8['wait'](200));
        }
      }
  ...
  if (p[_0x5bc515]) {
    ...
    if (a["status"] == 0) {
      if (_0x459e63 >= a["version"]) {
        _0x2e716e = true;
        _0x75eec0 = "https://ghproxy.com/https://raw.githubusercontent.com/seh23231/bb/main/ks.json";
...
function Envcc(T, c) {
  const p = {
    ...
    'dceom': 'ijzfe',
    'JighY': 'updateMsg',
    'uwDzR': "https://ghproxy.com/https://raw.githubusercontent.com/seh23231/bb/main/ks.json",
    'CvmUM': function (S, a) {
      return S === a;
    },
    'QfLFC': "JwVvM",
    ...
    [p["QrmhW"]](S, a) {
      if (p["JpIGP"]('ViWHE', p["NOwog"])) {
        if (p["QwtqA"](q, i[p["LTEld"]])) {
          d = true;
          u = "https://ghproxy.com/https://raw.githubusercontent.com/seh23231/bb/main/ks.json";
